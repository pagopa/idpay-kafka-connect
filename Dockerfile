...
RUN gradle getMongoKafkaConnectDeps && \
    ...
    curl -L https://repo1.maven.org/maven2/io/debezium/debezium-scripting/2.6.0.Final/debezium-scripting-2.6.0.Final.jar \
    --output "/deps/debezium-postgres/debezium-connector-postgres/debezium-scripting-2.6.0.Final.jar" && \
